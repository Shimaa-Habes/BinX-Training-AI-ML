...
- *Histogram:* Most records have low CO2 values, but a few large countries/regions push the average way up — classic right skew.
- *Scatter:* No clear trend across all countries combined, but the highest-emitting entities seem to be emitting more in recent years.
- *Bar:* The "top 10" are actually aggregated regions like "World" and "High income" — not individual countries. That tells me I'd need to filter those out for any proper country-level comparison.
